export const DE_TEXTS = {
    ...
    removedOAuthProviderNotice: 'Der Anmelde-Provider für das ChatGPT-Abo wurde in diesem Build entfernt; der Provider wurde zurückgesetzt und seine gespeicherten Zugangsdaten gelöscht. Bitte Provider und Modell in den Einstellungen neu wählen.',
    removedProviderResetNotice: 'In diesem Vault war ein Anbieter konfiguriert, den dieser Build nicht mehr enthält. Der Anbieter wurde auf den Standard zurückgesetzt und die gespeicherten Cloud-Anmeldeinformationen wurden gelöscht — wähle in den Einstellungen einen Anbieter und trage einen Schlüssel ein.',
    unsupportedPlatform: 'LLM Wiki unterstützt Windows nicht. Das Plugin wurde nicht geladen.',
    ...
    sourceRejectedPdfUnsupported: '⏭️ „{filename}" übersprungen — Ihr aktueller Provider oder das Modell akzeptiert keine PDF-Eingabe. Wechseln Sie den Provider, aktivieren Sie „Force PDF support" unter Settings → LLM Configuration → Advanced und versuchen Sie es erneut.',
